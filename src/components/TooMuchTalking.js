      ...
      <IntroduceWrap id="introduce">
        <div className="float-wrap">
          <div className="left">
            ...
            <p className="kr-text">
              ...
              화면단에서의 고객의 추가기능 요청사항은 도전정신을 자극하는 복잡한
              로직을 필요로 하는 경우가 있었습니다. 이 화면단 작업이 가장
              재밌었습니다. 자연스레 프로젝트의 코어개발이 끝난후 퍼블리싱을
              입힌 후에 추가적으로 고객사로부터 복잡한 추가기능 요청이
              들어오기를 기다리게 됐습니다.
            </p>
          </div>
          ...
          <div className="right">
            ...
            <p className="kr-text">
              ...
              높은 점유율 덕에 많은 레퍼런스들과 다양한 서드파티 라이브러리들이
              존재한다는 장점덕에 다른 라이브러리를 학습해야할 필요성은 아직
              느끼지 못하고 있습니다.
            </p>
          </div>
        </div>
        ...
        <div className="float-wrap">
          <div className="left">
            ...
            <p className="kr-text">
              협업을 하다보면 내가 만든 모듈을 협업자들에게 공유하고 이에 대해서
              개발이 한결 편리해졌다는 피드백을 받을때 뿌듯함을 느끼게 됩니다.
              사용자가 원하는 프로그램을 만드는 개발자, 그 개발을 수월하게
              만드는 라이브러리, 이 라이브러리를 만든다는 것은 정말 멋진
              일이라고 생각합니다. 저 또한 여러 라이브러리를 사용하여 개발능률을
              향상시킬수 있었습니다. 만들어진 라이브러리를 쓰는데에 멈추지 않고,
              직접 만든 라이브러리를 배포하여 다른 개발자들에게 도움이
              될수있기를 바라며 기회가 될때마다 NPM에 패키지를 올리고 있습니다.
            </p>
          </div>
          ...
          <div className="right">
            ...
            <p className="kr-text">
              ...
              갈때 커피에 관심이 많은 동료가 있으면 짧은 경험이나마 커피에 대한
              이야기를 해주는 소소한 낙도 있습니다.
            </p>
          </div>
        </div>
        ...
        <div className="float-wrap">
          <div className="left">
            ...
            <p className="kr-text">
              ...
              국비지원교육을 받으며 좀더 실력을 쌓는편이 좋겠다고 생각해서 자바
              웹 개발자를 양성하는 국비지원교육을 6개월간 수료하였습니다.
              경력자로서 아무래도 아는 내용이 더 많았기에 강의내용을 좀더 자세히
              알고싶어하는 학우들에게 저만의 포인트로 다시한번 강의내용을
              설명해주면서 도움을 주고는 했습니다. 교육과정 내에서 수행하는
              팀프로젝트에서는 여러 팀에서 디버깅 도움 요청이 쇄도하였고,
              저에게는 이때가 엄청난 성장의 기회였습니다. 역시 가장 좋은
              학습방법은 누군가를 가르쳐주는 것이라고 생각합니다.
            </p>
          </div>
          ...
          <div className="right">
            ...
            <p className="kr-text">
              국비지원교육을 수강하던 때에 취업강점을 위해 정보처리기사 자격증을
              따라는 충고를 들었고, 전문학사 자격으로 응시 가능한
